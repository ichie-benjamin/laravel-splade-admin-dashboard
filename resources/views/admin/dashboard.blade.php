<x-app-layout>
    ...
    <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        <!-- ====== Chart One Start -->
        @include('admin.partials.dashboard.chart-01')
        <!-- ====== Chart One End -->

        <!-- ====== Chart Two Start -->
        @include('admin.partials.dashboard.chart-02')
        <!-- ====== Chart Two End -->

        <!-- ====== Chart Three Start -->
        @include('admin.partials.dashboard.chart-03')
        <!-- ====== Chart Three End -->

        <!-- ====== Map One Start -->
        @include('admin.partials.dashboard.chart-04')
        <!-- ====== Map One End -->

        <!-- ====== Table One Start -->
        <div class="col-span-12 xl:col-span-8">
            @include('admin.partials.dashboard.table-01')
        </div>
        <!-- ====== Table One End -->
