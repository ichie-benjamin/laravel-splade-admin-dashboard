  ...
  <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
    ...
    <div class="flex items-center gap-3 2xsm:gap-7">
      <ul class="flex items-center gap-2 2xsm:gap-4">
        ...
        <li class="relative dropdown dropdown-hover-">
            <div tabindex="0" role="button" class="btn- m-1">
                <span class="relative flex h-8.5 w-8.5 items-center
                justify-center rounded-full border-[0.5px] border-stroke
                 bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4
                 dark:text-white">
            <span :class="!side_menu.notifying && 'hidden'" class="absolute -top-0.5
            right-0 z-1 h-2 w-2 rounded-full bg-meta-1">
              <span
...
{{--                </ul>--}}
            ...
            <div tabindex="0"
                 class="dropdown-content absolute  -right-27 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80">
        ...
        <li class="relative dropdown">
                <span tabindex="0" role="button" class="relative flex h-8.5
                w-8.5 items-center justify-center rounded-full border-[0.5px]
                border-stroke bg-gray hover:text-primary dark:border-strokedark
                 dark:bg-meta-4 dark:text-white">
            <span :class="!side_menu.notifying && 'hidden'"
      ...
      <div class="relative dropdown">
        <span tabindex="0" role="button" class="flex items-center gap-4">
          <span class="hidden text-right lg:block">
            <span class="block text-sm truncate font-medium text-black dark:text-white">{{ auth()->user()->name }}</span>
          ...
          <svg  class="hidden fill-current sm:block" width="12" height="8"
        ...
        <!-- Dropdown Start -->
        <div tabindex="0"
          class="absolute dropdown-content right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
