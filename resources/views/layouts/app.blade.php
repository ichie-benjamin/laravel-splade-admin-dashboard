...
<div class="antialiased bg-gray-50 dark:bg-gray-900">
    ...
    border-gray-800 px-4 py-2.5 dark:bg-gray-800
    dark:border-gray-700 fixed left-0 right-0 top-0 z-20">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center z-30">
    ...
    <main class="p-4 md:ml-24 h-auto pt-20">

        @if(isset($header))
            <header class="bg-white shadow-sm dark:bg-gray-800 mb-3 sm:rounded-lg">
                <div class="max-w-7xl- mx-auto dark:text-white py-6 px-4 sm:px-6 lg:px-8">
                    {{ $header }}
                </div>
            </header>
